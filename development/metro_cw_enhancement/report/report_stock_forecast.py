    ...
    def init(self):
        ...
        self._cr.execute("""CREATE or REPLACE VIEW report_stock_forecast AS (SELECT
                ...
                (SELECT
                    ...
                    SUM(sm.cw_product_qty) AS cw_product_qty,
                    sm.company_id
                    FROM
                       stock_move as sm
                    LEFT JOIN
                    ...
                    source_location.usage != 'internal' and source_location.usage != 'view' and dest_location.usage = 'internal'
                    ...
                    WHERE
                        sm.state IN ('confirmed','partially_available','assigned','waiting') and
                    source_location.usage = 'internal' and dest_location.usage != 'internal' and dest_location.usage != 'view' 
                    GROUP BY sm.date_expected,sm.product_id, sm.company_id)
                 as MAIN
             LEFT JOIN
