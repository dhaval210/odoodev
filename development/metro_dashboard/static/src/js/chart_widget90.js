odoo.define("metro_dashboard.Chart90", function(require) {
    "use strict";
    ...
    let ChartWidget = Widget.extend({
        ...
        init: function(parent) {
            ...
            this.keys = parent.recordData.keys90 || ""
            ...
            this.data = {
                "result": parent.recordData.result90 || "[]",
                "keys": this.keys,
    ...
    // widget tag
    widget_registry.add("metro_dashboard_chart90", ChartWidget);
