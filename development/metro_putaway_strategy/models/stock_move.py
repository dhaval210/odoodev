            ...
            if move.location_id.should_bypass_reservation()\
                ...
                if not move.move_orig_ids:
                    ...
                    if available_quantity <= 0:
                        continue
                    taken_quantity = move.with_context(avoid_locations=ctx_avoid_locations)._update_reserved_quantity(need, available_quantity, move.location_id, package_id=forced_package_id, strict=False)
