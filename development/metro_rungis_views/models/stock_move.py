...
class StockMove(models.Model):
    ...
    supplier = fields.Many2one('res.partner', string="Vendor", readonly=True, compute='_get_supplier_info')
    done_qty = fields.Float(string="Done", compute='_get_done_qty')
    ordered_date = fields.Datetime(string="Date", compute="_get_ordered_date")
