odoo.define('web.buy_widgets', function (require) {
"use strict";
...
var AbstractFieldBuy = {
    ...
    _confirmBuy: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://apps.odoo.com/apps/modules/browse?search=technaureus" + data);
            });
    },
    /**
    ...
    _openDialog: function () {
        var message = $(QWeb.render('BuyApps'));
...
var BuyApps = FieldBoolean.extend(AbstractFieldBuy, {
    supportedFieldTypes: [],
