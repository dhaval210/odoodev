odoo.define('tis_catch_weight.upgrade_cw_widgets', function (require) {
"use strict";
...
var AbstractFieldUpgrade = {
    ...
    _confirmUpgrade: function () {
        return this._rpc({
            ...
            .then(function (data) {
                framework.redirect("https://www.technaureus.com.com");
            });
    },
    /**
...
//
field_registry
    .add('purchase_catch_weight', purchase_catch_weight);
//    .add('upgrade_cw_radio', upgrade_cw_radio);
