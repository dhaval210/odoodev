...
class ProductReplenish(models.TransientModel):
    ...
    product_cw_uom_category_id = fields.Many2one('uom.category', related='product_id.cw_uom_id.category_id',
                                                 readonly=True,
                                                 required=True)
    product_cw_uom_id = fields.Many2one('uom.uom', string='Unity of measure', required=True)
